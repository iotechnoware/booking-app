import 'package:gofly/addpaymentwithcard.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        ...
        child: SizedBox(
          ...
          child: FloatingActionButton.extended(
            label: const Text("NEXT",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16,fontFamily: 'Gilroy'),),
            elevation: 0,
      ...
      body: Column(
        children: [
          ...
          Text(
            "No Card Added Yet",
            style: TextStyle(color: notifire.getdarkscolor,fontWeight: FontWeight.w600, fontSize: 24,fontFamily: 'Gilroy'),
          ),
          const SizedBox(height:8),
          const Text('You don’t added any credit cards',style:TextStyle(
            color: Colors.grey,
            fontSize: 16,fontWeight: FontWeight.w400,fontFamily: 'Gilroy'
          ),),
          const Text('yet.Please add the card for transaction',style:TextStyle(
            color: Colors.grey,
            fontSize: 16,fontWeight: FontWeight.w400,fontFamily: 'Gilroy'
          ),),
         //SizedBox(height: 161),
