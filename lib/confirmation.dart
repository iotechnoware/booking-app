      ...
      floatingActionButton: Padding(
        ...
        child: SizedBox(
          ...
          child: FloatingActionButton.extended(
            label: const Text("BACK TO HOME",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16,fontFamily: 'Gilroy'),),
            elevation: 0,
                                                  ...
                                                  child: Text(
                                                    ...
                                                    style: TextStyle(
                                                        ...
                                                        fontWeight:
                                                            FontWeight.w400,
                                                        color:
                                                            Color(0xff848D94),fontFamily: 'Gilroy'),
                                                  ),
                                                ),
                                              ),
                                              Center(
                      ...
                      children: [
                        ...
                        TextButton(
                          ...
                          child: const Text(
                            'Price breakdown',
                            style:
                            TextStyle(fontSize: 16, fontWeight: FontWeight.w400,fontFamily: 'Gilroy'),
                          ),
                        ),
                      ],
                    ),
