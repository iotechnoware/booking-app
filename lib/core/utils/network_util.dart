...
class NetworkUtil {
  ...
  // static String baseUrl = 'https://api.travelpayouts.com/aviasales/v3/prices_for_dates';
  static String flightUrl = 'api.travelpayouts.com';
  ...
  static Future<dynamic> customSendRequest({
    required RequestType type,
    required String url,
    ...
    try {
      var uri = Uri.https(customUrl, url, params);
      late http.Response response;
  ...
  static Future<dynamic> customSendMultipartRequest({
    required String url,
    required String customUrl,
    required RequestType type,
    Map<String, String>? headers = const {},
    ...
    try {
      var request = http.MultipartRequest(type.name , Uri.https(customUrl, url, params));
