...
class explorepageseeallbestdestination extends StatefulWidget {
  const explorepageseeallbestdestination({Key? key}) : super(key: key);

  @override
  State<explorepageseeallbestdestination> createState() => _explorepageseeallbestdestinationState();
}

// ignore: camel_case_types
class _explorepageseeallbestdestinationState extends State<explorepageseeallbestdestination> {
                ...
                children: [
                  Container(
                    ...
                    child: ClipRRect(
                        borderRadius: BorderRadius.circular(16),
                        child:
                        Image.network("${bestdestinations[index].image4}",fit: BoxFit.cover,)),
                  ),
