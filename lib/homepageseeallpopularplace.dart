...
class homepageseeallpopularplace extends StatefulWidget {
  const homepageseeallpopularplace({Key? key}) : super(key: key);

  @override
  State<homepageseeallpopularplace> createState() =>
      _homepageseeallpopularplaceState();
}

// ignore: camel_case_types
class _homepageseeallpopularplaceState
    extends State<homepageseeallpopularplace> {
