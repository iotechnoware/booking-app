...
class explorepageseeallbestdeals extends StatefulWidget {
  const explorepageseeallbestdeals({Key? key}) : super(key: key);

  @override
  State<explorepageseeallbestdeals> createState() => _explorepageseeallbestdealsState();
}

// ignore: camel_case_types
class _explorepageseeallbestdealsState extends State<explorepageseeallbestdeals> {
