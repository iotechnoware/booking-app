...
class explorepageseealldealsbymonth extends StatefulWidget {
  const explorepageseealldealsbymonth({Key? key}) : super(key: key);

  @override
  State<explorepageseealldealsbymonth> createState() => _explorepageseealldealsbymonthState();
}

// ignore: camel_case_types
class _explorepageseealldealsbymonthState extends State<explorepageseealldealsbymonth> {
