...
import 'package:gofly/searchflightmulticity.dart';
import 'package:gofly/searchflightoneday.dart';
import 'package:gofly/searchflightroundtrip.dart';
          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [const roundtrip(), const oneday(), const multicity()],
              ),
            ),
          ],
        ),
