import 'package:gofly/securecheckout.dart';
      ...
      floatingActionButton: Padding(
        ...
        child: SizedBox(
          ...
          child: FloatingActionButton.extended(
            label: const Text("ADD CARD",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16,fontFamily: 'Gilroy'),),
            elevation: 0,
              ...
              child: Row(
                children: [
                  ...
                  const Text(
                    ...
                    style: TextStyle(fontWeight: FontWeight.w400, fontSize: 14,color: Color(0xff9299A0),fontFamily: 'Gilroy'),
                  ),
                ],
              ),
            ),
