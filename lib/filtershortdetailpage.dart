  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        decoration: BoxDecoration(border: Border.all(color: Colors.black12),color: notifire.bottomnavigationbarbacground,
        ),
        child: Center(
          child: Row(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                   Text(
                    'DEA',
                    style: TextStyle(color: notifire.getdarkscolor,fontSize: 24, fontWeight: FontWeight.w400,fontFamily: 'Gilroy'),
                  ),
                  Column(
                    children: [
                      SizedBox(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              fontWeight: FontWeight.w400,
                              fontSize: 12,
                              color: Color(0xff848D94),fontFamily: 'Gilroy'),
                        ),
                      ),
                    ),
                    Padding(
