                ...
                child: Column(
                  ...
                  children: [
                     Text(
                      'Airlines',
                      style:
                          TextStyle(color:notifire.getdarkscolor,fontSize: 18, fontWeight: FontWeight.w600,fontFamily: 'Gilroy'),
                    ),
                    Expanded(
                      child: Padding(
                                ...
                                CheckboxListTile(
                                  ...
                                  subtitle: const Text(
                                    ...
                                    style: TextStyle(
                                        fontWeight: FontWeight.w400,
                                        fontSize: 12,
                                        color: Color(0xff9299A0),fontFamily: 'Gilroy'),
                                  ),
                                  onChanged: (bool? val) {
...
class CheckBoxListTileModel {
  ...
  static List<CheckBoxListTileModel> getUsers() {
    return <CheckBoxListTileModel>[
      CheckBoxListTileModel(
          userId: 1,
          img: 'assets/old_images/Air_France-Logo-PNG1.png',
          title: "Air France",
          subtitle: "\$4,985",
          isCheck: false),
      CheckBoxListTileModel(
          userId: 2,
          img: 'assets/old_images/Qatar_Airways-Logo-PNG3.png',
          title: "Qatar Airways",
          subtitle: "\$4,985",
          isCheck: false),
      CheckBoxListTileModel(
          userId: 3,
          img: 'assets/old_images/American_Airlines_(3).png',
          title: "American Airlines",
          subtitle: "\$4,985",
          isCheck: false),
      CheckBoxListTileModel(
          userId: 4,
          img: 'assets/old_images/Airbus-Logo-PNG1.png',
          title: "Airbus",
          subtitle: "\$4,985",
          isCheck: false),
      CheckBoxListTileModel(
          userId: 5,
          img: 'assets/old_images/United_Airlines_(1).png',
          title: "United Airlines",
          subtitle: "\$4,985",
          isCheck: false),
      CheckBoxListTileModel(
          userId: 6,
          img: 'assets/old_images/Emirates-Logo-PNG1) 1.png',
          title: "Fly Emirates",
          subtitle: "\$4,985",
          isCheck: false),
      CheckBoxListTileModel(
          userId: 7,
          img: 'assets/old_images/Lufthansa-Logo-PNG2 1.png',
          title: "Luftahansa",
          subtitle: "\$4,985",
          isCheck: false),
      CheckBoxListTileModel(
          userId: 5,
          img: 'assets/old_images/Turkish_Airlines-Logo-PNG1 1.png',
